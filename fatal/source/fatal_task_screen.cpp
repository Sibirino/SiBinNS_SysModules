...
namespace ams::fatal::srv {
    ...
    namespace {
        ...
        Result ShowFatalTask::ShowFatal() {
            ...
            font::AddSpacingLines(0.5f);
            font::PrintFormatLine(u8"Firmware: %s (SiBin %u.%u)", config.GetFirmwareVersion().display_version, ATMOSPHERE_RELEASE_VERSION, ams::GetGitRevision());
            ...
            if (!exosphere::ResultVersionMismatch::Includes(this->context->result)) {
                ...
                font::Print(u8"SiBin version mismatch detected.\n\n"
                                   ...
                                   u8"Please ensure that all SiBin components are updated.\n"
            ...
            font::PrintLine("https://SiBin.guide/");
            font::SetFontColor(0xFFFF);
            font::AddSpacingLines(0.5f);
            font::Print("Discord: ");
            font::SetFontColor(linkCol);
